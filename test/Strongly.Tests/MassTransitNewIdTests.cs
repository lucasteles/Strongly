...
public class MassTransitNewIdTests
{
    ...
    {
        var value = NewId.Next();
        var result = NewIdId1.TryParse(value.ToString(), out var foo);
        var bar = new NewIdId1(value);
    ...
    public void CanDeserializeFromNewId_WithNewtonsoftJsonProvider()
    {
        ...
        var deserializedFoo =
            NewtonsoftJsonSerializer.DeserializeObject<NewtonsoftJsonNewIdId>(serializedNewId);
    ...
    public void CanDeserializeFromNewId_WithSystemTextJsonProvider()
    {
        ...
        var deserializedFoo =
            SystemTextJsonSerializer.Deserialize<SystemTextJsonNewIdId>(serializedNewId);
    ...
    public void CanSerializeToNewId_WithBothJsonConverters()
    {
        ...
        var serializedNewId2 =
            SystemTextJsonSerializer.Serialize(foo.Value.ToGuid().ToString());
    ...
    public async Task WhenDapperValueConverterUsesValueConverter()
    {
        ...
        var results =
            await connection.QueryAsync<DapperNewIdId>(
                "SELECT '5640dad4-862a-4738-9e3c-c76dc227eb66'");

        var value = Assert.Single(results);
        Assert.Equal(
            new DapperNewIdId(
                NewId.FromGuid(Guid.Parse("5640dad4-862a-4738-9e3c-c76dc227eb66"))), value);
    }
    ...
    public class ConventionsDbContext : DbContext
    {
            ...
            ModelConfigurationBuilder configurationBuilder)
        {
            configurationBuilder
                .Properties<EfCoreNewIdId>()
                .HaveConversion<EfCoreNewIdId.EfValueConverter>();
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder
                .Entity<TestEntity>(builder =>
                {
                    builder
                        .Property(x => x.Id)
                        .HasConversion(new EfCoreNewIdId.EfValueConverter())
                        .ValueGeneratedNever();
                });
        }
    }
