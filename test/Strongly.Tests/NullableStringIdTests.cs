...
namespace Strongly.IntegrationTests
{
    public class NullableStringIdTests
    {
        ...
        public void CanDeserializeFromString_WithNewtonsoftJsonProvider()
        {
            ...
            var deserializedFoo =
                NewtonsoftJsonSerializer.DeserializeObject<NewtonsoftJsonNullableStringId>(
                    serializedString);
        ...
        public void CanDeserializeFromString_WithSystemTextJsonProvider()
        {
            ...
            var deserializedFoo =
                SystemTextJsonSerializer.Deserialize<SystemTextJsonNullableStringId>(
                    serializedString);
        ...
        public void WhenEfValueConverterUsesValueConverter()
        {
            ...
            { Id = Guid.NewGuid(), Name = new EfCoreNullableStringId("some name") };
        ...
        public async Task WhenDapperValueConverterUsesValueConverter()
        {
            ...
            var results =
                await connection.QueryAsync<DapperNullableStringId>("SELECT 'this is a value'");
        ...
        public void ImplementsInterfaces()
        {
            ...
            Assert.IsAssignableFrom<IEquatable<EquatableNullableStringId>>(EquatableNullableStringId
                .Empty);
            Assert.IsAssignableFrom<IComparable<ComparableNullableStringId>>(
                ComparableNullableStringId.Empty);
        ...
        public class ConventionsDbContext : DbContext
        {
                ...
                ModelConfigurationBuilder configurationBuilder)
            {
                configurationBuilder
                    ...
                    .HaveConversion<EfCoreNullableStringId.EfValueConverter>();
            }
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder)
            {
                modelBuilder
                    .Entity<TestEntity>(builder =>
                    {
                        builder
                            .Property(x => x.Name)
                            .HasConversion(new EfCoreNullableStringId.EfValueConverter())
                            .ValueGeneratedNever();
                    });
            }
        }
