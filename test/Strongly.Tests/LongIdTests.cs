...
namespace Strongly.IntegrationTests
{
    public class LongIdTests
    {
        ...
        public void CanDeserializeFromLong_WithNewtonsoftJsonProvider()
        {
            ...
            var deserializedFoo =
                NewtonsoftJsonSerializer.DeserializeObject<NewtonsoftJsonLongId>(serializedLong);
        ...
        public void CanDeserializeFromLong_WithSystemTextJsonProvider()
        {
            ...
            var deserializedFoo =
                SystemTextJsonSerializer.Deserialize<SystemTextJsonLongId>(serializedLong);
        ...
        public class ConventionsDbContext : DbContext
        {
                ...
                ModelConfigurationBuilder configurationBuilder)
            {
                configurationBuilder
                    ...
                    .HaveConversion<EfCoreLongId.EfValueConverter>();
            }
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder)
            {
                modelBuilder
                    .Entity<TestEntity>(builder =>
                    {
                        builder
                            .Property(x => x.Id)
                            .HasConversion(new EfCoreLongId.EfValueConverter())
                            .ValueGeneratedNever();
                    });
            }
        }
