    ...
    public class StringIdTests
    {
        ...
        public async Task ThrowsIfTryToCreateWithNull()
        {
            await Assert.ThrowsAsync<ArgumentNullException>(() =>
                Task.FromResult(new StringId(null)));
        }
        ...
        public void ShouldThrowWhenInvalid() =>
            Assert.Throws<InvalidOperationException>(() => new InvalidStringId());
        ...
        public void CanDeserializeFromString_WithNewtonsoftJsonProvider()
        {
            ...
            var deserializedFoo =
                NewtonsoftJsonSerializer
                    .DeserializeObject<NewtonsoftJsonStringId>(serializedString);
        ...
        public void CanDeserializeFromString_WithSystemTextJsonProvider()
        {
            ...
            var deserializedFoo =
                SystemTextJsonSerializer.Deserialize<SystemTextJsonStringId>(serializedString);
        ...
        public void WhenEfValueConverterUsesValueConverter()
        {
            ...
            { Id = Guid.NewGuid(), Name = new EfCoreStringId("some name") };
        ...
        public class ConventionsDbContext : DbContext
        {
                ...
                ModelConfigurationBuilder configurationBuilder)
            {
                configurationBuilder
                    ...
                    .HaveConversion<EfCoreStringId.EfValueConverter>();
            }
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder)
            {
                modelBuilder
                    .Entity<TestEntity>(builder =>
                    {
                        builder
                            .Property(x => x.Name)
                            .HasConversion(new EfCoreStringId.EfValueConverter())
                            .ValueGeneratedNever();
                    });
            }
        }
