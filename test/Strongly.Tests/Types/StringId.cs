...
[Strongly(StronglyType.String, implementations: StronglyImplementations.IEquatable)]
public partial struct CtorStringId
{
    public CtorStringId(string value) => Value = value.ToLower();
}