...
namespace Strongly.IntegrationTests
{
    public class IntIdTests
    {
        ...
        public void ShouldThrowWhenInvalid() =>
            Assert.Throws<InvalidOperationException>(() => new InvalidIntId());
        ...
        public void CanDeserializeFromInt_WithNewtonsoftJsonProvider()
        {
            ...
            var deserializedFoo =
                NewtonsoftJsonSerializer.DeserializeObject<NewtonsoftJsonIntId>(serializedInt);
        ...
        public void CanDeserializeFromInt_WithSystemTextJsonProvider()
        {
            ...
            var deserializedFoo =
                SystemTextJsonSerializer.Deserialize<SystemTextJsonIntId>(serializedInt);
        ...
        public class ConventionsDbContext : DbContext
        {
                ...
                ModelConfigurationBuilder configurationBuilder)
            {
                configurationBuilder
                    ...
                    .HaveConversion<EfCoreIntId.EfValueConverter>();
            }
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder)
            {
                modelBuilder
                    .Entity<TestEntity>(builder =>
                    {
                        builder
                            .Property(x => x.Id)
                            .HasConversion(new EfCoreIntId.EfValueConverter())
                            .ValueGeneratedNever();
                    });
            }
        }
